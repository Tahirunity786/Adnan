...
from core_profile.views import (ArchievedPostList, FollowUser, UnfollowUser, FollowersList, FollowingList, Profile,Get_Profile, Share_profile, UpdateProfile, Close_friend, ReCloseFriend, CloseFriendList, SavedPostList, likePostList, AddStoryView)
...
urlpatterns = [
    ...
    path('public/u/profile/story', AddStoryView.as_view(), name="profile-story"),  # Endpoint to add story
]
