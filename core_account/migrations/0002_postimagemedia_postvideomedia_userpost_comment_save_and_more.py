    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.ManyToManyField(related_name='posts', to='core_account.postimagemedia')),
                ...
                ('videos', models.ManyToManyField(blank=True, related_name='posts', to='core_account.postvideomedia')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='core_account.userpost')),
            ],
        ),
        migrations.CreateModel(
            name='Save',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core_account.userpost')),
            ],
            options={
