...
from core_account.views import (ChangePasswordAccount, CreateUserView, DeactvateAccount, ForgotPassword, GoogleAuthAPIView, GetNewOtp, ResetPassword, VerifyOtp, SocialLoginView, UserLogin, UserSearchView, MutePeopleView, BlockedPeopleView, MakeaccoutPrivate)
...
urlpatterns = [
    ...
    path("public/u/verify-2fa", verify_2fa, name="verify-2fa"),
    ...
    path('public/u/block', BlockedPeopleView.as_view(), name='block-account'),
    path('public/u/unblock', BlockedPeopleView.as_view(), name='unblock-account'),
    # Endpoint for make account private
